...
static bool create_data_writer(uxrSession *session, uxrStreamId reliable_out_stream_id, uxrObjectId participant_id,
			       ORB_ID orb_id, uint8_t orb_instance, const char *client_namespace, const char *topic, uint32_t message_version, const char *type_name,
			       uxrObjectId &datawriter_id)
{
	...
	uxrObjectId topic_id = topic_id_from_orb(orb_id, orb_instance);
